...
class MetroAgi:
    ...
    def heuristic(self, mevcut: Istasyon, hedef: Istasyon) -> int:
        ...
        return 1  # Basit bir heuristic (eşit mesafeli varsayım)
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
        ...
        pq = [(0, id(baslangic), baslangic, [baslangic])]  # (toplam_süre, id, mevcut, rota)
        ziyaret_edildi = {}
        ...
        while pq:
            ...
            if mevcut == hedef:
                return rota, toplam_sure  # En hizli rota bulundu
